        ...
        <div class="card-body">
          ...
          <form action="" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="namaBarang" aria-describedby="emailHelp" name="Nama_barang">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="keterangan" aria-describedby="emailHelp" name="Keterangan">
            </div>
            <div class="mb-3">
...
if(isset($_POST['submit'])){
    ...
    $tambahElektronik = $elektronik->tambahElektronik($kodeBarang,$namaBarang,$tanggal,$keterangan,$jumlah,$kondisi);

    if($elektronik = 'Tambah Data Berhasil'){
        ...
        window.location.href='tambah_barang_elektronik.php'</script>";
    }
}
