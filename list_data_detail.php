...
<html lang="en">
  ...
  <body>
    ...
    <div class="card-container d-flex justify-content-center animate__animated animate__fadeInDown" style="margin-top: 50px;">
      <div class="card" style="width: 80rem; height: 55vh;">
        <div class="card-body">
          <h3 class="card-title d-flex justify-content-center">Tabel Data Detail Peminjaman</h3>
        ...
        <?php
        require "libraryDataDetail.php";
        $semuaElektronik = new LibraryDataDetail();
        $tampilSemua = $semuaElektronik->tampilSemua();
        while($data = $tampilSemua->fetch(PDO::FETCH_OBJ)){
          echo "
          <tbody>
          <tr>
